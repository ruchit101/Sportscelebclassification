...
def classify_image(image_base64_data, file_path=None):  # return classification result either you provide base64 img or file path
...
def class_number_to_name(class_num):  # return class name (sports celebrity name) from class number 0,1,2,3,4,5 for each of the 
    return __class_number_to_name[class_num]

def load_saved_artifacts(): # loading model from the path
...
def get_cv2_image_from_base64_string(b64str):  # return decoded image form base64 string  
    '''
...
def get_b64_test_image_for_virat(): # sample image() for reading function  
