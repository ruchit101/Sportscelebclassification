...
function init() {
    ...
    dz.on("complete", function (file) {
        ...
        $.post(url, {
        ...
        },function(data, status) {   // response is returned in this function as data.
            /* 
            ...
            */
            ...
            let players = ["lionel_messi", "maria_sharapova", "saina_nehwal","roger_federer", "serena_williams", "virat_kohli"];
